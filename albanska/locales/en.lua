local Translations = {
    error = {
        ...
        on_duty_albanska_only = 'For on-duty albanska only',
    ...
    info = {
        ...
        blip_text = 'albanska Alert - %{text}',
        jail_time_input = 'Jail time',
        submit = 'Submit',
        time_months = 'Time in Months',
        bill = 'Bill',
        amount = 'Amount',
        albanska_plate = 'LSPD', --Should only be 4 characters long
    ...
    menu = {
        garage_title = 'albanska Vehicles',
        close = '⬅ Close Menu',
        impound = 'Impounded Vehicles',
        pol_impound = 'albanska Impound',
        pol_garage = 'albanska Garage',
        pol_armory = 'albanska Armory',
    },
    email = {
        sender = 'Central Judicial Collection Agency',
        subject = 'Debt collection',
        message = 'Dear %{value}. %{value2}, <br /><br />The Central Judicial Collection Agency (CJCA) charged the fines you received from the albanska.<br />There is <strong>$%{value3}</strong> withdrawn from your account.<br /><br />Kind regards,<br />Mr. I.K. Graai',
    },
    commands = {
        place_spike = 'Place Spike Strip (albanska Only)',
        license_grant = 'Grant a license to someone',
        license_revoke = 'Revoke a license from someone',
        place_object = 'Place/Delete An Object (albanska Only)',
        cuff_player = 'Cuff Player (albanska Only)',
        escort = 'Escort Player',
        callsign = 'Give Yourself A Callsign',
        clear_casign = 'Clear Area of Casings (albanska Only)',
        jail_player = 'Jail Player (albanska Only)',
        unjail_player = 'Unjail Player (albanska Only)',
        clearblood = 'Clear The Area of Blood (albanska Only)',
        seizecash = 'Seize Cash (albanska Only)',
        softcuff = 'Soft Cuff (albanska Only)',
        camera = 'View Security Camera (albanska Only)',
        flagplate = 'Flag A Plate (albanska Only)',
        unflagplate = 'Unflag A Plate (albanska Only)',
        plateinfo = 'Run A Plate (albanska Only)',
        depot = 'Impound With Price (albanska Only)',
        impound = 'Impound A Vehicle (albanska Only)',
        paytow = 'Pay Tow Driver (albanska Only)',
        paylawyer = 'Pay Lawyer (albanska, Judge Only)',
        anklet = 'Attach Tracking Anklet (albanska Only)',
        ankletlocation = 'Get the location of a persons anklet',
        removeanklet = 'Remove Tracking Anklet (albanska Only)',
        drivinglicense = 'Seize Drivers License (albanska Only)',
        takedna = 'Take a DNA sample from a person (empty evidence bag needed) (albanska Only)',
        albanska_report = 'albanska Report',
