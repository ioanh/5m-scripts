...
-- Events
RegisterNetEvent('albanska:client:ActiveCamera', function(cameraId)
...
RegisterNetEvent('albanska:client:DisableAllCameras', function()
    for k, v in pairs(Config.SecurityCameras.cameras) do 
        Config.SecurityCameras.cameras[k].isOnline = false
    end
end)

RegisterNetEvent('albanska:client:EnableAllCameras', function()
    for k, v in pairs(Config.SecurityCameras.cameras) do 
        Config.SecurityCameras.cameras[k].isOnline = true
    end
end)

RegisterNetEvent('albanska:client:SetCamera', function(key, isOnline)
