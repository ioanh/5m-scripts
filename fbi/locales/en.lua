local Translations = {
    error = {
        ...
        on_duty_fbi_only = 'For on-duty fbi only',
    ...
    info = {
        ...
        blip_text = 'fbi Alert - %{text}',
        jail_time_input = 'Jail time',
        submit = 'Submit',
        time_months = 'Time in Months',
        bill = 'Bill',
        amount = 'Amount',
        fbi_plate = 'LSPD', --Should only be 4 characters long
    ...
    menu = {
        garage_title = 'fbi Vehicles',
        close = '⬅ Close Menu',
        impound = 'Impounded Vehicles',
        pol_impound = 'fbi Impound',
        pol_garage = 'fbi Garage',
        pol_armory = 'fbi Armory',
    },
    email = {
        sender = 'Central Judicial Collection Agency',
        subject = 'Debt collection',
        message = 'Dear %{value}. %{value2}, <br /><br />The Central Judicial Collection Agency (CJCA) charged the fines you received from the fbi.<br />There is <strong>$%{value3}</strong> withdrawn from your account.<br /><br />Kind regards,<br />Mr. I.K. Graai',
    },
    commands = {
        place_spike = 'Place Spike Strip (fbi Only)',
        license_grant = 'Grant a license to someone',
        license_revoke = 'Revoke a license from someone',
        place_object = 'Place/Delete An Object (fbi Only)',
        cuff_player = 'Cuff Player (fbi Only)',
        escort = 'Escort Player',
        callsign = 'Give Yourself A Callsign',
        clear_casign = 'Clear Area of Casings (fbi Only)',
        jail_player = 'Jail Player (fbi Only)',
        unjail_player = 'Unjail Player (fbi Only)',
        clearblood = 'Clear The Area of Blood (fbi Only)',
        seizecash = 'Seize Cash (fbi Only)',
        softcuff = 'Soft Cuff (fbi Only)',
        camera = 'View Security Camera (fbi Only)',
        flagplate = 'Flag A Plate (fbi Only)',
        unflagplate = 'Unflag A Plate (fbi Only)',
        plateinfo = 'Run A Plate (fbi Only)',
        depot = 'Impound With Price (fbi Only)',
        impound = 'Impound A Vehicle (fbi Only)',
        paytow = 'Pay Tow Driver (fbi Only)',
        paylawyer = 'Pay Lawyer (fbi, Judge Only)',
        anklet = 'Attach Tracking Anklet (fbi Only)',
        ankletlocation = 'Get the location of a persons anklet',
        removeanklet = 'Remove Tracking Anklet (fbi Only)',
        drivinglicense = 'Seize Drivers License (fbi Only)',
        takedna = 'Take a DNA sample from a person (empty evidence bag needed) (fbi Only)',
        fbi_report = 'fbi Report',
