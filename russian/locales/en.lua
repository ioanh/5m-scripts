local Translations = {
    error = {
        ...
        on_duty_russian_only = 'For on-duty russian only',
    ...
    info = {
        ...
        blip_text = 'russian Alert - %{text}',
        jail_time_input = 'Jail time',
        submit = 'Submit',
        time_months = 'Time in Months',
        bill = 'Bill',
        amount = 'Amount',
        russian_plate = 'LSPD', --Should only be 4 characters long
    ...
    menu = {
        garage_title = 'russian Vehicles',
        close = '⬅ Close Menu',
        impound = 'Impounded Vehicles',
        pol_impound = 'russian Impound',
        pol_garage = 'russian Garage',
        pol_armory = 'russian Armory',
    },
    email = {
        sender = 'Central Judicial Collection Agency',
        subject = 'Debt collection',
        message = 'Dear %{value}. %{value2}, <br /><br />The Central Judicial Collection Agency (CJCA) charged the fines you received from the russian.<br />There is <strong>$%{value3}</strong> withdrawn from your account.<br /><br />Kind regards,<br />Mr. I.K. Graai',
    },
    commands = {
        place_spike = 'Place Spike Strip (russian Only)',
        license_grant = 'Grant a license to someone',
        license_revoke = 'Revoke a license from someone',
        place_object = 'Place/Delete An Object (russian Only)',
        cuff_player = 'Cuff Player (russian Only)',
        escort = 'Escort Player',
        callsign = 'Give Yourself A Callsign',
        clear_casign = 'Clear Area of Casings (russian Only)',
        jail_player = 'Jail Player (russian Only)',
        unjail_player = 'Unjail Player (russian Only)',
        clearblood = 'Clear The Area of Blood (russian Only)',
        seizecash = 'Seize Cash (russian Only)',
        softcuff = 'Soft Cuff (russian Only)',
        camera = 'View Security Camera (russian Only)',
        flagplate = 'Flag A Plate (russian Only)',
        unflagplate = 'Unflag A Plate (russian Only)',
        plateinfo = 'Run A Plate (russian Only)',
        depot = 'Impound With Price (russian Only)',
        impound = 'Impound A Vehicle (russian Only)',
        paytow = 'Pay Tow Driver (russian Only)',
        paylawyer = 'Pay Lawyer (russian, Judge Only)',
        anklet = 'Attach Tracking Anklet (russian Only)',
        ankletlocation = 'Get the location of a persons anklet',
        removeanklet = 'Remove Tracking Anklet (russian Only)',
        drivinglicense = 'Seize Drivers License (russian Only)',
        takedna = 'Take a DNA sample from a person (empty evidence bag needed) (russian Only)',
        russian_report = 'russian Report',
