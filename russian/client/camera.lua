...
-- Events
RegisterNetEvent('russian:client:ActiveCamera', function(cameraId)
...
RegisterNetEvent('russian:client:DisableAllCameras', function()
    for k, v in pairs(Config.SecurityCameras.cameras) do 
        Config.SecurityCameras.cameras[k].isOnline = false
    end
end)

RegisterNetEvent('russian:client:EnableAllCameras', function()
    for k, v in pairs(Config.SecurityCameras.cameras) do 
        Config.SecurityCameras.cameras[k].isOnline = true
    end
end)

RegisterNetEvent('russian:client:SetCamera', function(key, isOnline)
