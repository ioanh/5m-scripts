local Translations = {
    error = {
        ...
        on_duty_russian mafia_only = 'For on-duty russian mafia only',
    ...
    info = {
        ...
        blip_text = 'russian mafia Alert - %{text}',
        jail_time_input = 'Jail time',
        submit = 'Submit',
        time_months = 'Time in Months',
        bill = 'Bill',
        amount = 'Amount',
        russian mafia_plate = 'LSPD', --Should only be 4 characters long
    ...
    menu = {
        garage_title = 'russian mafia Vehicles',
        close = '⬅ Close Menu',
        impound = 'Impounded Vehicles',
        pol_impound = 'russian mafia Impound',
        pol_garage = 'russian mafia Garage',
        pol_armory = 'russian mafia Armory',
    },
    email = {
        sender = 'Central Judicial Collection Agency',
        subject = 'Debt collection',
        message = 'Dear %{value}. %{value2}, <br /><br />The Central Judicial Collection Agency (CJCA) charged the fines you received from the russian mafia.<br />There is <strong>$%{value3}</strong> withdrawn from your account.<br /><br />Kind regards,<br />Mr. I.K. Graai',
    },
    commands = {
        place_spike = 'Place Spike Strip (russian mafia Only)',
        license_grant = 'Grant a license to someone',
        license_revoke = 'Revoke a license from someone',
        place_object = 'Place/Delete An Object (russian mafia Only)',
        cuff_player = 'Cuff Player (russian mafia Only)',
        escort = 'Escort Player',
        callsign = 'Give Yourself A Callsign',
        clear_casign = 'Clear Area of Casings (russian mafia Only)',
        jail_player = 'Jail Player (russian mafia Only)',
        unjail_player = 'Unjail Player (russian mafia Only)',
        clearblood = 'Clear The Area of Blood (russian mafia Only)',
        seizecash = 'Seize Cash (russian mafia Only)',
        softcuff = 'Soft Cuff (russian mafia Only)',
        camera = 'View Security Camera (russian mafia Only)',
        flagplate = 'Flag A Plate (russian mafia Only)',
        unflagplate = 'Unflag A Plate (russian mafia Only)',
        plateinfo = 'Run A Plate (russian mafia Only)',
        depot = 'Impound With Price (russian mafia Only)',
        impound = 'Impound A Vehicle (russian mafia Only)',
        paytow = 'Pay Tow Driver (russian mafia Only)',
        paylawyer = 'Pay Lawyer (russian mafia, Judge Only)',
        anklet = 'Attach Tracking Anklet (russian mafia Only)',
        ankletlocation = 'Get the location of a persons anklet',
        removeanklet = 'Remove Tracking Anklet (russian mafia Only)',
        drivinglicense = 'Seize Drivers License (russian mafia Only)',
        takedna = 'Take a DNA sample from a person (empty evidence bag needed) (russian mafia Only)',
        russian mafia_report = 'russian mafia Report',
